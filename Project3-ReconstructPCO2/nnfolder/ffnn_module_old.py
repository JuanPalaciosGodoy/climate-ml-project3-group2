...
class FeedForwardNN:
    ...
    def save_model(self, model_path, scaler_X_path=None, scaler_y_path=None):
        ...
        scaler_X_path : str, optional
            Path to save the feature scaler
        scaler_y_path : str, optional
            Path to save the target scaler
        """
    ...
    def load_model(cls, model_path, scaler_X_path=None, scaler_y_path=None):
        ...
        scaler_y_path : str, optional
            Path to the saved target scaler
            
        Returns:
        --------
        instance : FeedForwardNN
            Instance with loaded model and scalers
        """
